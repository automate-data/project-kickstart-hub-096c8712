...
import { Timer, Calendar, Truck, User, PenTool } from 'lucide-react';
...
export function PackageDetailsDialog({ open, onOpenChange, pkg }: PackageDetailsDialogProps) {
  if (!pkg) return null;
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-sm">Assinatura de retirada</span>
            </div>
            {pkg.signature_data ? (
